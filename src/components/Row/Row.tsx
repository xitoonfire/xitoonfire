...
interface RowProps {
  children: ReactNode;
  gap?: 'none' | 'small' | 'medium' | 'large'; // Gap between row items
  alignItems?: 'start' | 'center' | 'end'; // Vertical alignment of items
  justifyContent?: 'start' | 'center' | 'end' | 'between' | 'around'; // Horizontal alignment
}
